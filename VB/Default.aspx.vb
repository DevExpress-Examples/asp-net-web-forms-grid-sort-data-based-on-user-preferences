...
'INSTANT VB NOTE: The variable adapter was renamed since Visual Basic does not handle local variables named the same as class members well:
			Dim adapter_Conflict As New OleDbDataAdapter(String.Empty, connection)
			adapter_Conflict.SelectCommand.CommandText = "SELECT [CategoryID], [CategoryName], [Description] FROM [Categories]"
			adapter_Conflict.Fill(dataTable)
		End Using
